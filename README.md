...
- **Validator** — checks that a parsed process is structurally sound and reports errors in the editor: undeclared-variable warnings, declared-type mismatches, duplicate attribute keys, and missing `class` on a service task.

...
- `external-task.bpmnscript` — hands a shipment-label print-out to an external worker polling the `print-label` topic. Exercises the service task's `topic` binding.

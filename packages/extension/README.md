...
| `test/conversion.test.ts`                | Unit tests for the VS Code adapter (`conversion.ts`), with `vscode` mocked: notification wording, the single-filename-prefix contract, aggregated import-warning notifications |

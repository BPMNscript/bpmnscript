...
- [src/bpmn-script.langium](src/bpmn-script.langium) -  The grammar definition of your language
- [src/bpmn-script-module.ts](src/bpmn-script-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/bpmn-script-validator.ts](src/bpmn-script-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/bpmn-script.monarch.ts](src/syntaxes/bpmn-script.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/bpmn-script.tmLanguage.json](syntaxes/bpmn-script.tmLanguage.json) - Textmate based syntax highlighting instructions.

...
Which surface should BPMNscript use: a flat graph declaration, or a structured, code-like language with implicit sequence flow and block-scoped control statements?
...
Chosen option: "Structured code-like syntax", because it matches how developers already write sequential logic.
